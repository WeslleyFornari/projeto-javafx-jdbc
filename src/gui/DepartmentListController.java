...
public class DepartmentListController implements Initializable, DataChangeListener {
	...
	@FXML
	private TableColumn<Department, Department> tableColumnREMOVE; // OBJETO PARA DELETAR
	...
	private void removeEntity(Department obj) {
		Optional<ButtonType> result = Alerts.showConfirmation("Confirmar","Você tem certeza que deseja concluir");
		...
		try {
			depService.remove(obj); //REMOVE O DEPARTMEENTO
			upDateTableView();  // ATUALIZA A TABELA NA TELA
		}
